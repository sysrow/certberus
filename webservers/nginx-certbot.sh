...
Pouziti: $0 [OPTIONS]
  ...
  -v, --verbose        Debug
      ...
      --eab-kid KID
      --eab-hmac HMAC
      --no-firewall    Nikdy automaticky nemenit firewall
      --open-firewall  Explicitne povolit firewall mutace (vcetne HARICA)
...
main() {
    ...
    run_stage test_reload   # prvni test nginx konfigurace (pred issue)
